						...
						<tbody>
							@if ( count($record) > 0 )
								...
								<tr>
                                    ...
                                    <td>
                                        @if ( $records->user->address )
                                         {{ $records->user->address->ic}}<br>
                                         {{ $records->user->address->address}}<br>
                                         {{ $records->user->address->poscode}}<br>
                                         {{ $records->user->address->state}}
                                        @endif
                                    </td>
                                    <td>{{ $records->product_info->product_name_en}}</td>
									<td>{{ $records->delivery_type}}</td>
